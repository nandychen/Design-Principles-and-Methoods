		...
		double deltaTheta=0; //Variable to store change in angle required
			...
			// Carries out falling edge localization
			  ...
			  //robot stops as it has seen a wall
			   ...
			   roboCop.rotate(Odometer.minimumAngleFromTo(correctTheta, 0)); // robot turns to 0 degrees and faces north
			   roboCop.moveForward(10);  // move a little forward
			   roboCop.stop(); // robot stops
			   roboCop.rotate(Odometer.minimumAngleFromTo(0, 90)); // robot turns 90 degrees and face positive x
			   roboCop.moveForward(13);  // moves a little to the right
			   roboCop.rotate(Odometer.minimumAngleFromTo(90, 0));
			  } 
		else {
			   ...
			   roboCop.rotate(Odometer.minimumAngleFromTo(correctTheta, 0)-6); // robot faces north
			   roboCop.moveForward(10);  //moves a little forward
			   roboCop.stop(); // robot stops
			   roboCop.rotate(Odometer.minimumAngleFromTo(0, 90)); // robot  faces positive x
			   roboCop.moveForward(13);  // moves a little right
		}
	 }
/******************************************************************FILTER METHOD*****************************************************************/
