...
// This class drives robot in a square
/*
 * Group 30
...
public class SquareDriver {
	private static final int FORWARD_SPEED =100; // the speed has been altered to give better results while using odometry correction to ensure light sensor reads lines correctly.
	public static final int ROTATE_SPEED = 150; //this is used in odometry correction to prevent reading lines during a turn.
